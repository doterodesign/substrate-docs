...
<AccordionGroup>
  <Accordion title="Always-accessible contrast">
    Every foreground in every context meets its APCA target by construction — foreground Lc 75, borders Lc 50, focus rings Lc 60, scaled by the user's contrast preference. Shortfalls are reported explicitly, and a build-failing accessibility gate keeps every shipped brand honest.
  </Accordion>
