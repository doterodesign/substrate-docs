...
| Component states | state tokens from a component's config | The generated state-layer rules |
| Component modes | modes defined in a component's config | That mode's property values and deltas |
