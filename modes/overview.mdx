...
```css
[data-brand="magic-patterns"] { /* light, contrastFactor 1.0 */ }

@media (prefers-color-scheme: dark) {
  [data-brand="magic-patterns"] { /* the dark preset */ }
}

@media (prefers-contrast: more) {
  [data-brand="magic-patterns"] { /* the highContrast preset */ }
}

@media (prefers-color-scheme: dark) and (prefers-contrast: more) {
  [data-brand="magic-patterns"] { /* the darkHighContrast preset */ }
}
```
